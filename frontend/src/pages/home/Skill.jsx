  ...
  return (
    <div id='skills'>
        ...
        <div className='flex flex-col items-center justify-center w-full'>
            <p className='text-white text-2xl py-8 '>Here are some of my skills on which I have been working on for the past 3 years.</p>
            <div className='skillsContainer w-full flex flex-wrap'>
                
                    <div className='skills bg-card max-w-2xl'>
